...
There's a `BaseDaoTests` class that all the tests inherit from. This base class along with the `TemporaryDatabaseConfig` class take care of the following:
